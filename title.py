...
def app_title():
    st.markdown(
        """
		<h1 style='text-align: center; color: #ff0099; margin-bottom: 0.5em;'>KellCare Nursing Home Finder</h1>
...
def sidebar_title(title: str, subtitle: str = None):
    st.sidebar.markdown(f"<h2 style='color: #ff0099; margin-bottom: 0.2em;'>{title}</h2>", unsafe_allow_html=True)
    if subtitle:
